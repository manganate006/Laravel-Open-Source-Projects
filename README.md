...
| Project Name                             | Description                                                  |	Credit			|
| ----------------------------------       | ------------------------------------------------------------ |-----------------|
| [OpenLMNP](https://github.com/manganate006/openlmnp) [P] | French LMNP (furnished rental) accounting app built with Laravel 13 & Filament 5. Computes per-component depreciation, generates the French tax return (2031/2033) and FEC accounting export, imports Airbnb/Booking.com bookings, and includes a micro-BIC vs. real regime simulator. AGPLv3, with a built-in MCP server for AI assistant integration. | [manganate006](https://github.com/manganate006) |
